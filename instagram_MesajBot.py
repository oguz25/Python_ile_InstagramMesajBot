#Bu uygulamayı arkadaşlarınızla eğlenmek, Kız/Erkek arkadaşınıza mesaj göndermek
#Ve daha bir çok sebeple kullanabilirsiniz.

#Kodların çalışması için 'Firefoxun son sürümü',
#'Selenium Kütüphanesi' ve Firefox için webdriver
#olan 'geckodriver' indirmeniz gerekiyor ve
#indirdiğiniz exe dosyasını
#bilgisayarınız Path'ine eklemeniz gerekiyor.
#(Path için internetten nasıl yapıldığına bakınız.
#Ya da youtubda Selenium kullanımı olarak aratırsanız,
#kullanım için gerekli aşamaları tarif eden videolara erişebilirsiniz)

#Uygulama çalışırken elle müdahale edeceğiniz bir durum olmayacak.
#Programı kullanmadan önce kodlarda Kullanıcı adı ve şifre kısmını ekleyiniz.
